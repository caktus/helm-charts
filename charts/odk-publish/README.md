...
| `odk-publish.ingress.hosts`                              | Ingress hosts.                                         | `[{"host": "chart-example.local", "paths": [{"path": "/", "pathType": "ImplementationSpecific"}]}]` |
...
| `odk-publish.ingressApp.hosts`                           | Ingress hosts for second Ingress.                      | `[{"host": "chart-example.local", "paths": [{"path": "/", "pathType": "ImplementationSpecific"}]}]` |
...
| `asgi.ingress.hosts`                                     |                                                        | `[{"host": "chart-example.local", "paths": [{"path": "/ws", "pathType": "Prefix"}]}]`               |
| `asgi.ingress.tls`                                       |                                                        | `[]`                                                                                                |
| `asgi.ingressApp.enabled`                                |                                                        | `false`                                                                                             |
| `asgi.ingressApp.className`                              |                                                        | `"nginx"`                                                                                           |
| `asgi.ingressApp.annotations`                            |                                                        | `{}`                                                                                                |
| `asgi.ingressApp.hosts`                                  |                                                        | `[{"host": "chart-example.local", "paths": [{"path": "/", "pathType": "ImplementationSpecific"}]}]` |
| `asgi.ingressApp.tls`                                    |                                                        | `[]`                                                                                                |
| `asgi.resources`                                         |                                                        | `{}`                                                                                                |
